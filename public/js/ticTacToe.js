...
function addSpectatorSigil(key) {
	if (tilesList[key].coord === 'row2col2') {
...
const onNewSpectator = (data) => {
	...
	renderExistingSprites(data.tilesLib);
}

function renderExistingSprites(libMap) {
	let coordMap = buildCoordinates.coordinates;
